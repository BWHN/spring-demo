...
@Schema(description = "管理后台 - 交易大厅-车源管理分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TradehallCarSourcePageReqVO extends PageParam {
