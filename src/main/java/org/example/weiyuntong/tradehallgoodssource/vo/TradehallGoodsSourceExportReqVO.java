...
@Schema(description = "管理后台 - 交易大厅-货源管理 Excel 导出 Request VO，参数和 TradehallGoodsSourcePageReqVO 是一致的")
@Data
public class TradehallGoodsSourceExportReqVO {
    ...
    private PriceUnitEnum goodsPriceUnit;
