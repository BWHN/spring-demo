...
public class TradeHallOrderDetailVO {
    ...
    private List<TradeHallOrderSourceVO> toIssuedWaybilCarList;
    @Schema(description = "待送达运单信息")
    private List<TradeHallOrderSourceVO> toDeliveryedWaybilCarList;
    @Schema(description = "待核对运单信息")
    private List<TradeHallOrderSourceVO> toCheckedWaybilCarList;
    @Schema(description = "待对账运单信息")
    private List<TradeHallOrderSourceVO> toCheckeBillWaybilCarList;
    @Schema(description = "待结算运单信息")
    private List<TradeHallOrderSourceVO> inSettlementWaybilCarList;
    @Schema(description = "已完结运单信息")
    private List<TradeHallOrderSourceVO> finishedWaybilCarList;
    @Schema(description = "异常运单信息")
    private List<TradeHallOrderSourceVO> abnormalWaybilCarList;
