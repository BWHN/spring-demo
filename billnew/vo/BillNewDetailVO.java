...
public class BillNewDetailVO extends BillSourceCreateVO {
    ...
    @Schema(description = "忽略金额原因")
    private String ignoreAmountRemark;
    ...
    @Schema(description = "忽略开票原因")
    private String ignoreInvoiceRemark;
    ...
    @Schema(description = "账单类型desc")
    private String billServiceTypeDesc;
    ...
    @Schema(description = "是否展示账单利润")
    private Boolean haveBillProfit;
}
